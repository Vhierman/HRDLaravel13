...
@section('content')
        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    <li class="breadcrumb-item active" aria-current="page">Karyawan PKWT</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body p-4">
            <h5 class="mb-4">Proses Kontrak Kerja Karyawan PKWT Berdasarkan Tanggal</h5>
            <form action="{{ route('kontrak_kerja.proses_tanggal_pkwt') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row g-3">
                    <div class="col-12 col-lg-12">
                        <label class="form-label fs-6">Tanggal Berakhir Kontrak Kerja</label>
                        <input type="date" name="tanggal_akhir_kontrak" value="{{ old('tanggal_akhir_kontrak') }}"
                ...
                <div class="row g-3 mt-2">
                    <div class="col-12 col-lg-6">
                        ...
                        <input type="date" name="tanggal_awal_perpanjang" value="{{ old('tanggal_awal_perpanjang') }}"
                            class="form-control" placeholder="dd/mm/yyyy">
                    </div>
                    <div class="col-12 col-lg-6">
                        <label class="form-label fs-6">Tanggal Akhir Perpanjang Kontrak</label>
                        <input type="date" name="tanggal_akhir_perpanjang" value="{{ old('tanggal_akhir_perpanjang') }}"
                            class="form-control" placeholder="dd/mm/yyyy">
                    </div>
                </div>
