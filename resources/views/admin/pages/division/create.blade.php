...
@section('content')
        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    <li class="breadcrumb-item active" aria-current="page">Tambah Data Penempatan</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body p-4">
            <h5 class="mb-4">Form Tambah Penempatan</h5>
            <form action="{{ route('division.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="penempatan" value="{{ old('penempatan') }}"
                    ...
                    <div class="col-sm-9">
                        <div class="d-md-flex d-grid align-items-center gap-3">
                            <div class="row row-cols-auto g-3">
                                ...
                                <div class="col">
                                    <a href="{{ route('division.index') }}" class="btn btn-danger px-4 raised d-flex gap-2">
