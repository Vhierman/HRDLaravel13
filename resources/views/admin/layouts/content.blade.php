            ...
            <div class="card-body">
                <div class="">
                    <div class="d-flex align-items-center gap-2 mb-2">
                        ...
                        <img src="{{ asset('template_template_admin/assets/images/apps/party-popper.png') }}"
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <img src="{{ asset('template_template_admin/assets/images/apps/gift-box-3.png') }}"
                            width="100" alt="">
                    </div>
                </div>
            </div>
                    ...
                    <div class="d-flex flex-column gap-4">
                        <div class="d-flex align-items-center gap-3">
                            <div class="social-icon d-flex align-items-center gap-3 flex-grow-1">
                                <img src="{{ asset('template_template_admin/assets/images/apps/17.png') }}"
                                    width="40" alt="">
                                <div>
                        ...
                        <div class="d-flex align-items-center gap-3">
                            <div class="social-icon d-flex align-items-center gap-3 flex-grow-1">
                                <img src="{{ asset('template_template_admin/assets/images/apps/twitter-circle.png') }}"
                                    width="40" alt="">
                                <div>
                        ...
                        <div class="d-flex align-items-center gap-3">
                            <div class="social-icon d-flex align-items-center gap-3 flex-grow-1">
                                <img src="{{ asset('template_template_admin/assets/images/apps/03.png') }}"
                                    width="40" alt="">
                                <div>
                        ...
                        <div class="d-flex align-items-center gap-3">
                            <div class="social-icon d-flex align-items-center gap-3 flex-grow-1">
                                <img src="{{ asset('template_template_admin/assets/images/apps/19.png') }}"
                                    width="40" alt="">
                                <div>
                        ...
                        <div class="d-flex align-items-center gap-3">
                            <div class="social-icon d-flex align-items-center gap-3 flex-grow-1">
                                <img src="{{ asset('template_template_admin/assets/images/apps/20.png') }}"
                                    width="40" alt="">
                                <div>
    ...
    <div class="col-12 col-lg-6 col-xxl-4 d-flex">
        <div class="card w-100 rounded-4">
            <div class="card-body">
                ...
                <div class="d-flex flex-column gap-4">
                    <div class="d-flex align-items-center gap-3">
                        <img src="{{ asset('template_template_admin/assets/images/top-products/01.png') }}"
                    ...
                    <div class="d-flex align-items-center gap-3">
                        <img src="{{ asset('template_template_admin/assets/images/top-products/02.png') }}"
                            width="55" class="rounded-circle" alt="">
                        <div class="flex-grow-1">
                    ...
                    <div class="d-flex align-items-center gap-3">
                        <img src="{{ asset('template_template_admin/assets/images/top-products/04.png') }}"
                            width="55" class="rounded-circle" alt="">
                        <div class="flex-grow-1">
                    ...
                    <div class="d-flex align-items-center gap-3">
                        <img src="{{ asset('template_template_admin/assets/images/top-products/05.png') }}"
                            width="55" class="rounded-circle" alt="">
                        <div class="flex-grow-1">
                    ...
                    <div class="d-flex align-items-center gap-3">
                        <img src="{{ asset('template_template_admin/assets/images/top-products/06.png') }}"
                            width="55" class="rounded-circle" alt="">
                        <div class="flex-grow-1">
    ...
    <div class="col-12 col-lg-12 col-xxl-4 d-flex">
        <div class="card w-100 rounded-4">
            <div class="card-body">
                ...
                <div class="d-flex flex-column gap-4">
                    <div class="d-flex align-items-center gap-3">
                        <img src="{{ asset('template_template_admin/assets/images/avatars/01.png') }}" width="55"
                    ...
                    <div class="d-flex align-items-center gap-3">
                        <img src="{{ asset('template_template_admin/assets/images/avatars/02.png') }}" width="55"
                            class="rounded-circle" alt="">
                        <div class="flex-grow-1">
                            <h6 class="mb-0">Ajay Sidhu</h6>
                            <p class="mb-0">Sale: 879</p>
                    ...
                    <div class="d-flex align-items-center gap-3">
                        <img src="{{ asset('template_template_admin/assets/images/avatars/03.png') }}" width="55"
                            class="rounded-circle" alt="">
                        <div class="flex-grow-1">
                            <h6 class="mb-0">Ajay Sidhu</h6>
                            <p class="mb-0">Sale: 879</p>
                    ...
                    <div class="d-flex align-items-center gap-3">
                        <img src="{{ asset('template_template_admin/assets/images/avatars/04.png') }}" width="55"
                            class="rounded-circle" alt="">
                        <div class="flex-grow-1">
                            <h6 class="mb-0">Ajay Sidhu</h6>
                            <p class="mb-0">Sale: 879</p>
                    ...
                    <div class="d-flex align-items-center gap-3">
                        <img src="{{ asset('template_template_admin/assets/images/avatars/08.png') }}" width="55"
                            class="rounded-circle" alt="">
                        <div class="flex-grow-1">
                            <h6 class="mb-0">Ajay Sidhu</h6>
                            <p class="mb-0">Sale: 879</p>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center flex-row gap-3">
                                        <div class="">
                                            <img src="{{ asset('template_template_admin/assets/images/apps/paypal.png') }}"
                                                width="35" alt="">
                                        </div>
                                        <div class="">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center flex-row gap-3">
                                        <div class="">
                                            <img src="{{ asset('template_template_admin/assets/images/apps/13.png') }}"
                                                width="35" alt="">
                                        </div>
                                        <div class="">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center flex-row gap-3">
                                        <div class="">
                                            <img src="{{ asset('template_template_admin/assets/images/apps/behance.png') }}"
                                                width="35" alt="">
                                        </div>
                                        <div class="">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center flex-row gap-3">
                                        <div class="">
                                            <img src="{{ asset('template_template_admin/assets/images/apps/07.png') }}"
                                                width="35" alt="">
                                        </div>
                                        <div class="">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center flex-row gap-3">
                                        <div class="">
                                            <img src="{{ asset('template_template_admin/assets/images/apps/05.png') }}"
                                                width="35" alt="">
                                        </div>
                                        <div class="">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center flex-row gap-3">
                                        <div class="">
                                            <img src="{{ asset('template_template_admin/assets/images/apps/apple.png') }}"
                                                width="35" alt="">
                                        </div>
                                        <div class="">
