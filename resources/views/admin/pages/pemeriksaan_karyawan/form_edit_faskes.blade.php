...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-4">
            <h5 class="mb-4">Form Edit Faskes</h5>
            <form action="{{ route('pemeriksaan_karyawan.update_faskes', $faskes->id) }}" method="post"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="nama_faskes" value="{{ $faskes->nama_faskes }}"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="alamat" value="{{ $faskes->alamat }}"
                            id="input35" placeholder="Alamat Faskes" />
                    </div>
                </div>
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" onkeyup="angka(this);" name="rt"
                            value="{{ $faskes->rt }}" id="input36" placeholder="RT" maxlength="3" />
                    </div>
                </div>
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" onkeyup="angka(this);" name="rw"
                            value="{{ $faskes->rw }}" id="input36" placeholder="RW" maxlength="3" />
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="input35" class="col-sm-3 col-form-label">Kelurahan</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="kelurahan" value="{{ $faskes->kelurahan }}"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="kecamatan" value="{{ $faskes->kecamatan }}"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="kota" value="{{ $faskes->kota }}" id="input35"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="provinsi" value="{{ $faskes->provinsi }}"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" maxlength="5" onkeyup="angka(this);"
                            name="kode_pos" value="{{ $faskes->kode_pos }}" id="input35" placeholder="Kode POS" />
                    </div>
                </div>
                <div class="row">
