                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" onkeyup="huruf(this);" name="name"
                            value="{{ $user->name }}" id="input35" placeholder="Name" />
                    </div>
                </div>
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" onkeyup="angka(this);" name="nik"
                            value="{{ $user->nik }}" id="input36" placeholder="NIK" maxlength="16" />
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="input36" class="col-sm-3 col-form-label">Email Address</label>
                    <div class="col-sm-9">
                        <input type="email" class="form-control" name="email" value="{{ $user->email }}" id="input36"
                            placeholder="Email" />
                    </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        ...
                        <select id="input39" class="form-select" name="roles">
                            ...
                            <option value="admin" @if ($user->roles == 'admin') {{ 'selected="selected"' }} @endif>
                                Admin</option>
                            <option value="karyawan" @if ($user->roles == 'karyawan') {{ 'selected="selected"' }} @endif>
                                Karyawan</option>
                            <option value="hrd" @if ($user->roles == 'hrd') {{ 'selected="selected"' }} @endif>
                                HRD</option>
                            <option value="accounting" @if ($user->roles == 'accounting') {{ 'selected="selected"' }} @endif>
                                Accounting
                            </option>
