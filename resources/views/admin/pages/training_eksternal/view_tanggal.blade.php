    ...
    <div class="card">
        <div class="card-body">
            <div class="row row-cols-auto g-3">
                <div class="col">
                    <form action="{{ route('training_eksternal.excell_training_eksternal') }}" method="POST"
                        class="d-inline">
                        @csrf
                        ...
                        <button type="submit" class="btn btn-success px-5 raised">
                            Download Training Eksternal Periode
                ...
                <table id="example2" class="table table-striped table-bordered">
                    <thead>
                        ...
                        <tr class="search-row">
                            ...
                            <th><input type="text" class="form-control form-control-sm"
                                    placeholder="Cari Institusi Training..." />
                            </th>
                            <th><input type="text" class="form-control form-control-sm"
                            ...
                            <th><input type="text" class="form-control form-control-sm"
                                    placeholder="Cari Alamat Training..." />
                            </th>
                    ...
                    <tbody>
                        ...
                        @foreach ($item_training_eksternals as $item_training_eksternal)
                            <tr>
                                ...
                                <td>{{ $item_training_eksternal->employees->areas->area }}</td>
                                ...
                                <td>{{ $item_training_eksternal->alamat_training_eksternal }}</td>
