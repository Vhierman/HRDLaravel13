...
@section('content')
        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    <li class="breadcrumb-item active" aria-current="page">Lihat Overtime</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body p-4">
            <h5 class="mb-4">Cari Data Overtime</h5>
            <form action="{{ route('overtime.tampil_approve_overtime') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row g-3">
