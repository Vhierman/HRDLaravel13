...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-4">
            <h5 class="mb-4">Rekap Gaji Karyawan</h5>
            <form action="{{ route('salary.proses_rekap_salary') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row g-3">
                    ...
                    <div class="col-sm-12">
                        <div class="d-md-flex d-grid align-items-center gap-3">
                            <div class="row row-cols-auto g-3">
                                ...
                                <div class="col">
                                    <a href="{{ route('salary.index') }}" class="btn btn-danger px-4 raised d-flex gap-2">
                                        <i class="material-icons-outlined">cancel</i>Cancel
                                    </a>
                                </div>
                                <div class="col">
                                    <button type="button" class="btn btn-warning position-relative d-flex gap-2"><i
                                            class="material-icons-outlined">warning</i>Periode Rekap Gaji Mulai dari Tanggal
                                        26 sampai
                                        Tanggal
