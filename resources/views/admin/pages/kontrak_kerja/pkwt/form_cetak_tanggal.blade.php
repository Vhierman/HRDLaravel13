...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-4">
            <h5 class="mb-4">Cetak Kontrak Kerja Karyawan PKWT Berdasarkan Tanggal</h5>
            <form action="{{ route('kontrak_kerja.proses_cetak_tanggal_pkwt') }}" method="post"
                            ...
                            <div class="row row-cols-auto g-3">
                                <div class="col">
                                    <button type="submit" class="btn btn-primary px-4 raised d-flex gap-2"><i
                                            class="material-icons-outlined">print</i>Cetak Kontrak Kerja</button>
                                </div>
                            </div>
                        </div>
