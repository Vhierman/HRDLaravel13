    ...
    <div class="card">
        <div class="card-body">
            <div class="row justify-content-center g-2 text-center">
                <div class="col-md-6">
                    <a href="{{ route('kontrak_kerja.form_proses_tanggal_harian') }}"
                        class="btn btn-primary px-5 btn-sm py-2 w-100">Proses Kontrak Kerja Karyawan Harian
                        Berdasarkan Tanggal</a>
                </div>
                <div class="col-md-6">
                    <a href="{{ route('kontrak_kerja.form_proses_nama_harian') }}"
                        class="btn btn-primary px-5 btn-sm py-2 w-100">Proses Kontrak Kerja Karyawan Harian
                        Berdasarkan Nama</a>
                </div>
            </div>
            <div class="row justify-content-center g-2 text-center mt-0">
                <div class="col-md-12">
                    <a href="{{ route('kontrak_kerja.form_cetak_tanggal_harian') }}"
                        class="btn btn-success px-5 btn-sm py-2 w-100">Cetak Kontrak Kerja Karyawan Harian Berdasarkan
                        Tanggal</a>
                </div>
            </div>
        </div>
