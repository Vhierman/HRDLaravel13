...
@section('content')
        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    <li class="breadcrumb-item active" aria-current="page">Statistik Kecelakaan Kerja</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body p-4">
            <h5 class="mb-4 fs-4">Data Statistik Kecelakaan Kerja</h5>
            <form action="{{ route('safety.tampil_statistik_kecelakaan') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row g-3">
