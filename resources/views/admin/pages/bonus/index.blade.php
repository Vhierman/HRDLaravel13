        ...
        <div class="col-md-8 col-lg-6">
            <div class="card">
                ...
                <div class="card-body p-4">
                    <h5 class="mb-4">Bonus Tahunan</h5>
                    <form action="{{ route('bonus.tampil_penilaian_bonus') }}" method="post" target="_blank"
                                    ...
                                    <div class="row row-cols-auto g-3">
                                        <div class="col">
                                            <button type="submit" class="btn btn-primary px-4 raised d-flex gap-2"><i
                                                    class="material-icons-outlined">print</i>Cetak Penilaian</button>
                                        </div>
                                        <div class="col">
