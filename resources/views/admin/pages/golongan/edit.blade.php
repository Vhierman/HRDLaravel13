...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-4">
            <h5 class="mb-4">Form Edit Golongan</h5>
            <form action="{{ route('golongan.update', $golongan->id) }}" method="post" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="row mb-3">
                    <label for="input35" class="col-sm-3 col-form-label fs-6">Nama Golongan</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" onkeyup="huruf(this);" name="golongan"
                            value="{{ $golongan->golongan }}" id="input35" placeholder="Golongan" />
                    </div>
                </div>
                    ...
                    <div class="col-sm-9">
                        <div class="d-md-flex d-grid align-items-center gap-3">
                            <div class="row row-cols-auto g-3">
                                ...
                                <div class="col">
                                    <a href="{{ route('golongan.index') }}" class="btn btn-danger px-4 raised d-flex gap-2">
