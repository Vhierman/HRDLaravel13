    ...
    <div class="card">
        <div class="card-body">
            <div class="row row-cols-auto g-3">
                <div class="col">
                    <form action="{{ route('training_internal.excell_belum_training_internal') }}" method="POST"
                        class="d-inline">
                        @csrf
                ...
                <table id="example2" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        @foreach ($item_training_internals as $item_training_internal)
                            <tr>
                                <td>{{ $no++ }}</td>
                                <td>{{ $item_training_internal->nama_karyawan }}</td>
                                <td>{{ $item_training_internal->nik_karyawan }}</td>
                                <td>{{ $item_training_internal->areas->area }}</td>
                                <td>{{ $item_training_internal->positions->jabatan }}</td>
                                <td>{{ $item_training_internal->divisions->penempatan }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
