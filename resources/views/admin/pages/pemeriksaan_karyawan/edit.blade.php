...
@section('title', 'Edit Pemeriksaan Karyawan');
...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-4">
            <h5 class="mb-4">Form Edit Data Pemeriksaan Karyawan</h5>
            <form action="{{ route('pemeriksaan_karyawan.update', $pemeriksaan_karyawan->id) }}" method="post"
                ...
                <div class="row g-3">
                    <div class="col-12 col-lg-6">
                        ...
                        <select name="employees_id" class="form-select" id="karyawan-select"
                            ...
                            <option value="{{ $pemeriksaan_karyawan->employees_id }}">Pilih Karyawan</option>
                            @foreach ($employees as $employee)
                                <option value="{{ $employee->id }}"
                                    @if ($pemeriksaan_karyawan->employees_id == $employee->id) {{ 'selected="selected"' }} @endif>
                    ...
                    <div class="col-12 col-lg-6">
                        ...
                        <select name="faskes_id" class="form-select" id="faskes-select" data-placeholder="Pilih Faskes">
                            <option value="{{ $pemeriksaan_karyawan->faskes_id }}">Pilih Faskes</option>
                            @foreach ($faskess as $faskes)
                                <option value="{{ $faskes->id }}"
                                    @if ($pemeriksaan_karyawan->faskes_id == $faskes->id) {{ 'selected="selected"' }} @endif>
                                    {{ $faskes->nama_faskes }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="row g-3 mt-2">
                    <div class="col-12 col-lg-6">
                        ...
                        <input type="date" name="tanggal_pemeriksaan"
                            value="{{ $pemeriksaan_karyawan->tanggal_pemeriksaan }}" class="form-control"
                            placeholder="dd/mm/yyyy">
                    </div>
                    <div class="col-12 col-lg-6">
                        <label class="form-label fs-6">Nomor Pemeriksaan</label>
                        <input type="text" name="nomor_mcu" value="{{ $pemeriksaan_karyawan->nomor_mcu }}"
                            class="form-control" placeholder="Masukan Nomor Pemeriksaan">
                    </div>
                </div>
                <div class="row g-3 mt-2">
                    <div class="col-12 col-lg-6">
                        <label class="form-label fs-6">Petugas / Dokter Pemeriksa</label>
                        <input type="text" name="dokter_pemeriksa" value="{{ $pemeriksaan_karyawan->dokter_pemeriksa }}"
                    ...
                    <div class="col-12 col-lg-6">
                        ...
                        <select class="form-select" name="jenis_pemeriksaan" id="jenis_pemeriksaan-select"
                            ...
                            <option value="Awal" @if ($pemeriksaan_karyawan->jenis_pemeriksaan == 'Awal') {{ 'selected="selected"' }} @endif>
                                Awal</option>
                            <option value="Berkala" @if ($pemeriksaan_karyawan->jenis_pemeriksaan == 'Berkala') {{ 'selected="selected"' }} @endif>
                                Berkala</option>
                            <option value="Khusus" @if ($pemeriksaan_karyawan->jenis_pemeriksaan == 'Khusus') {{ 'selected="selected"' }} @endif>
                                Khusus</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="row g-3 mt-2">
                    <div class="col-12 col-lg-6">
                        ...
                        <input type="text" name="tekanan_darah" value="{{ $pemeriksaan_karyawan->tekanan_darah }}"
                            class="form-control" placeholder="Masukan Tekanan Darah">
                    </div>
                    <div class="col-12 col-lg-6">
                        <label class="form-label fs-6">Gula Darah</label>
                        <input type="text" name="gula_darah" value="{{ $pemeriksaan_karyawan->gula_darah }}"
                            class="form-control" placeholder="Masukan Gula Darah">
                    </div>
                </div>
                <div class="row g-3 mt-2">
                    <div class="col-12 col-lg-6">
                    ...
                    <div class="col-12 col-lg-6">
                        ...
                        <input type="date" name="tanggal_pemeriksaan_berikutnya"
                            value="{{ $pemeriksaan_karyawan->tanggal_pemeriksaan_berikutnya }}" class="form-control"
                            placeholder="dd/mm/yyyy">
                    </div>
                </div>
                <div class="row g-3 mt-2">
                    <div class="col-12 col-lg-6">
                        ...
                        <textarea name="catatan_dokter" class="form-control" placeholder="Masukan Catatan Dokter">{{ $pemeriksaan_karyawan->catatan_dokter }}</textarea>
                    </div>
                    <div class="col-12 col-lg-6">
                        ...
                        <select class="form-select" name="status_kelayakan" id="status_kelayakan-select"
                            ...
                            <option value="Fit" @if ($pemeriksaan_karyawan->status_kelayakan == 'Fit') {{ 'selected="selected"' }} @endif>
                                Fit</option>
                            <option value="Fit With Note"
                                @if ($pemeriksaan_karyawan->status_kelayakan == 'Fit With Note') {{ 'selected="selected"' }} @endif>
                                Fit With Note</option>
                            <option value="Unfit" @if ($pemeriksaan_karyawan->status_kelayakan == 'Unfit') {{ 'selected="selected"' }} @endif>
                                Unfit</option>
                        </select>
                        </select>
                    </div>
