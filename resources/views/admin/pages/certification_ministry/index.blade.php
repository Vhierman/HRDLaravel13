                    ...
                    <div class="btn-group position-static">
                        ...
                        <a href="{{ route('certification_ministry.exportExcel') }}" target="_blank"
                            ...
                            <button type="button" class="btn btn-success">
                                <i class="bi bi-cloud-arrow-down"></i> Download Data Sertifikasi Kementrian
                            </button>
                        </a>
                    </div>
                </div>
                ...
                <table id="example2" class="table table-striped table-bordered">
                    <thead>
                        ...
                        <tr class="search-row">
                            ...
                            <th><input type="text" class="form-control form-control-sm"placeholder="Cari Kementrian...">
                            </th>
                            <th><input type="text"
                    ...
                    <tbody>
                        ...
                        @foreach ($certification_ministries as $certification_ministry)
                            <tr>
                                <td>{{ $no++ }}</td>
                                <td>{{ $certification_ministry->employees->nik_karyawan }}</td>
                                <td>{{ $certification_ministry->employees->nama_karyawan }}</td>
                                <td>{{ $certification_ministry->jenis_sertifikat_kementrian }}</td>
                                <td>{{ $certification_ministry->nomor_sertifikat_kementrian }}</td>
                                <td>{{ $certification_ministry->lsp_kementrian }}</td>
                                <td>{{ \Carbon\Carbon::parse($certification_ministry->tanggal_terbit_kementrian)->isoformat('DD-MM-Y') }}
                                </td>
                                ...
                                @if ($canManage)
                                    <td class="text-center">
                                        <div class="action-container">
                                            <button type="button"
                                                onclick="window.location.href='{{ route('certification_ministry.edit', $certification_ministry->id) }}'"
