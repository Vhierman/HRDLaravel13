        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    <li class="breadcrumb-item active" aria-current="page">Hapus Training Internal</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="col-md-8 col-lg-6">
            <div class="card">
                ...
                <div class="card-body p-4">
                    <h5 class="mb-4">Hapus Data Training Internal Berdasarkan Tanggal</h5>
                    <form action="{{ route('training_internal.tampil_hapus_tanggal') }}" method="post"
