...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-4">
            <h5 class="mb-4">Proses Kontrak Kerja Karyawan Harian Berdasarkan Tanggal</h5>
            <form action="{{ route('kontrak_kerja.proses_tanggal_harian') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row g-3">
