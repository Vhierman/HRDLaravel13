...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-4">
            <h5 class="mb-4">Cari Data Karyawan Belum Pernah Training Berdasarkan Tanggal</h5>
            <form action="{{ route('training_internal.tampil_view_belum_training') }}" method="post"
