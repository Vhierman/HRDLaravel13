...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <div class="row g-3">
                <div class="col">
                    <form action="{{ route('overtime.proses_approve_overtime') }}" method="POST" class="d-inline">
                        @csrf
                        ...
                        <button type="submit" class="btn btn-primary px-5 raised w-100">
                            Approve Data Overtime Periode {{ \Carbon\Carbon::parse($tanggal_awal)->isoformat('DD-MM-Y') }}
                            s/d
