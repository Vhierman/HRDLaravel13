...
class BonusController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.pages.bonus.index',[
            'divisions' => $divisions
        ]);
    }
    ...
    public function tampil_penilaian_bonus(PenempatanRequest $request)
    {
        ...
        $penilaiankaryawans = Employees::with([
                            ...
                            'positions',
                            'golongans'
                            ])->where('golongans_id', [2])->where('divisions_id', $divisions)->get();
