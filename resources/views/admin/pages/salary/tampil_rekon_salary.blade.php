    ...
    <div class="card">
        <div class="card-body">
            <div class="row row-cols-auto g-3">
                <div class="col">
                    <form action="{{ route('salary.hasil_rekon_salary') }}" method="POST" class="d-inline">
                        @csrf
                        ...
                        <button type="submit" class="btn btn-primary px-5 raised">
                            Rekon Gaji Periode
                    ...
                    <a href="{{ route('salary.export_excell_rekon') }}" class="btn btn-success px-5 raised">
                        Download Excell Data Rekon Gaji Periode
                        {{ \Carbon\Carbon::parse($tanggal_awal)->isoformat('DD-MM-Y') }}
                        s/d
                        {{ \Carbon\Carbon::parse($tanggal_akhir)->isoformat('DD-MM-Y') }}
                    </a>
                    <a href="{{ route('salary.rekon_salary') }}" class="btn btn-danger px-5 raised">
                        Cancel Rekon
                    </a>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="action-container">
                                        <button type="button"
                                            onclick="window.location.href='{{ route('salary.edit', $item_salary->id) }}'"
