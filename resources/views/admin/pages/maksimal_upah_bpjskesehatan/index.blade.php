...
@section('title', 'Data Maksimal Upah BPJS Kesehatan');
        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    <li class="breadcrumb-item active" aria-current="page">Maksimal Upah BPJS Kesehatan</li>
                </ol>
            </nav>
        </div>
    </div>
    <div class="card">
        <div class="card-body">
            <div class="row row-cols-auto g-3">
                <div class="col">
                    <a href="{{ route('maksimal_upah_bpjskesehatan.create') }}" class="btn btn-primary px-5 raised">
                        Tambah Data Maksimal Upah BPJS Kesehatan
                    </a>
                </div>
            </div>
            <br>
            <div class="table-responsive">
                <table id="example2" class="table table-striped table-bordered">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Maksimal Upah BPJS Kesehatan</th>
                            <th>Action</th>
                        </tr>
                        <tr class="search-row">
                            <th></th>
                            <th><input type="text" class="form-control form-control-sm"
                                    placeholder="Cari Maksimal Upah BPJS Kesehatan..." />
                            </th>
                            <th></th>
                        </tr>
                    </thead>
                        ...
                        @foreach ($maksimal_upah_bpjskesehatans as $maksimal_upah_bpjskesehatan)
                            <tr>
                                ...
                                <td>
                                    <div class="row row-cols-auto g-3">
                                        <div class="col">
                                            <a href="{{ route('maksimal_upah_bpjskesehatan.edit', $maksimal_upah_bpjskesehatan->id) }}"
                                        ...
                                        <div class="col">
                                            <form
                                                action="{{ route('maksimal_upah_bpjskesehatan.destroy', $maksimal_upah_bpjskesehatan->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('delete')
