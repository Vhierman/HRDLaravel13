...
@section('title', 'Data Minimal Upah');
        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    <li class="breadcrumb-item active" aria-current="page">Minimal Upah</li>
                </ol>
            </nav>
        </div>
    </div>
                        ...
                        @foreach ($minimal_salaries as $minimal_salary)
                            <tr>
                                ...
                                <td>
                                    <div class="row row-cols-auto g-3">
                                        <div class="col">
                                            <a href="{{ route('minimal_salary.edit', $minimal_salary->id) }}"
                                                class="btn btn-success raised d-flex gap-2">
                                                <i class="material-icons-outlined">edit</i>
                                            </a>
                                        </div>
                                        <div class="col">
                                            <form action="{{ route('minimal_salary.destroy', $minimal_salary->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('delete')
