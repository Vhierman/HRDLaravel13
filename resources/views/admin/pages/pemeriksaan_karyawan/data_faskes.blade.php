            ...
            <div class="row row-cols-auto g-3">
                <div class="col">
                    <div class="btn-group position-static">
                        <a href="{{ route('pemeriksaan_karyawan.form_tambah_faskes') }}" class="btn-group position-static">
                            <button type="button" class="btn btn-primary">
                                <i class="bi bi-person-plus"></i> Tambah Faskes
                            </button>
                        </a>
                    </div>
                </div>
                ...
                <table id="example2" class="table table-striped table-bordered">
                    <thead>
                        ...
                        <tr class="search-row">
                            <th></th>
                            <th><input type="text"
                                    class="form-control form-control-sm"placeholder="Cari Nama Faskes..." /></th>
                            <th><input type="text"
                                    class="form-control form-control-sm"placeholder="Cari Alamat Faskes..." />
                            </th>
                            <th><input type="text"
                                    class="form-control form-control-sm"placeholder="Cari Kelurahan ..." />
                            </th>
                            <th><input type="text" class="form-control form-control-sm"placeholder="Cari Kecamatan..." />
                            </th>
                            <th><input type="text"
                                    class="form-control form-control-sm"placeholder="Cari Kota Faskes..." /></th>
                            <th></th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        @foreach ($faskess as $faskes)
                            <tr>
                                ...
                                <td>{{ $faskes->alamat }}</td>
                                <td>{{ $faskes->kelurahan }}</td>
                                <td>{{ $faskes->kecamatan }}</td>
                                <td>{{ $faskes->kota }}</td>
                                <td class="text-center">
                                    <div class="action-container">
                                        <button type="button"
                                            onclick="window.location.href='{{ route('pemeriksaan_karyawan.form_edit_faskes', $faskes->id) }}'"
                                            class="btn btn-sm btn-outline-success btn-action" title="Edit Data">
                                            <i class="material-icons-outlined">edit</i>
                                        </button>

                                        <form action="{{ route('pemeriksaan_karyawan.hapus_faskes', $faskes->id) }}"
        ...
        $(document).ready(function() {
            ...
            $('#example2').on('click', '.btn-delete', function(e) {
                ...
                Swal.fire({
                    ...
                    text: "Data Faskes ini akan dihapus permanen!",
                    icon: 'warning',
