            ...
            <form action="{{ route('pemeriksaan_karyawan.tambah_data_pemeriksaan') }}" method="post"
                ...
                <div class="row g-3 mt-2">
                    <div class="col-12 col-lg-6">
                        ...
                        <input type="text" name="berat_badan" value="{{ old('berat_badan') }}" class="form-control"
                            placeholder="Masukan Berat Badan" maxlength="5">
                    </div>
                    <div class="col-12 col-lg-6">
                        ...
                        <input type="text" name="tinggi_badan" value="{{ old('tinggi_badan') }}" class="form-control"
                            placeholder="Masukan Tinggi Badan" maxlength="5">
                    </div>
                </div>
                <div class="row g-3 mt-2">
                    <div class="col-12 col-lg-6">
                ...
                <div class="row g-3 mt-2">
                    <div class="col-12 col-lg-6">
                        ...
                        <input type="text" name="asam_urat" value="{{ old('asam_urat') }}" class="form-control"
                            placeholder="Masukan Asam Urat">
                    </div>
                    <div class="col-12 col-lg-6">
