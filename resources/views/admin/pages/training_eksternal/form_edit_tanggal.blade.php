        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    <li class="breadcrumb-item active" aria-current="page">Edit Training Eksternal</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="col-md-8 col-lg-6">
            <div class="card">
                ...
                <div class="card-body p-4">
                    <h5 class="mb-4">Edit Data Training eksternal Berdasarkan Tanggal</h5>
                    <form action="{{ route('training_eksternal.edit_tanggal') }}" method="post"
