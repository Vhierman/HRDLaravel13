...
@section('title', 'Statistik Pemeriksaan');
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-4">
            <h5 class="mb-4 fs-4">Statistik Pemeriksaan Karyawan</h5>
            <form action="{{ route('pemeriksaan_karyawan.tampil_data_statistik_pemeriksaan') }}" method="post"
