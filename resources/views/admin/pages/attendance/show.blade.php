            ...
            <div class="row row-cols-auto g-3">
                <div class="col">
                    <form action="{{ route('attendance.export_excell_absensi') }}" method="POST" class="d-inline">
                        @csrf
                        <input type="hidden" name="tanggal_awal" value="{{ old('tanggal_awal') }}" class="form-control"
                            value="{{ $tanggal_awal }}">
                        <input type="hidden" name="tanggal_akhir" value="{{ old('tanggal_akhir') }}" class="form-control"
                            value="{{ $tanggal_akhir }}">
