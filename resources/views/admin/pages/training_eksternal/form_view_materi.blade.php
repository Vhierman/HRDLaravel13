        ...
        <div class="col-md-8 col-lg-6">
            <div class="card">
                ...
                <div class="card-body p-4">
                    <h5 class="mb-4">Cari Data Training eksternal Berdasarkan Materi</h5>
                    <form action="{{ route('training_eksternal.tampil_view_materi') }}" method="post"
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <select name="perihal_training_eksternal" class="form-select" id="karyawan-select"
                                    data-placeholder="Pilih Materi Training">

                                    <option value="">Pilih Penempatan</option>
                                    @foreach ($item_training_eksternals as $item_training_eksternal)
                                        <option value="{{ $item_training_eksternal->perihal_training_eksternal }}"
                                            {{ old('perihal_training_eksternal') == $item_training_eksternal->perihal_training_eksternal ? 'selected' : '' }}>
                                            {{ $item_training_eksternal->perihal_training_eksternal }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
