    ...
    <section class="container px-3 section section__height d-flex align-items-center justify-content-center" id="skill">
        ...
        <div class="coming-soon-wrapper py-4">
            ...
            <p class="text-muted mx-auto mb-4" style="max-width: 450px; font-size: 0.95rem; line-height: 1.6;">
                Halaman modul <span class="text-dark fw-semibold">Skills & Kompetensi</span> saat ini sedang dalam proses
                integrasi sistem sistem internal. Kami akan segera kembali!
            </p>

            <div class="pt-2">
                <div class="d-flex justify-content-between max-width-progress mx-auto mb-2"
                    style="max-width: 300px; font-size: 0.8rem;">
                    <span class="text-muted fw-semibold">Development Progress</span>
                    <span class="fw-bold" style="color: var(--first-color);">50%</span>
                </div>
                <div class="custom-progress-bg shadow-sm">
