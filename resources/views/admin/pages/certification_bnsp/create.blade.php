...
@section('title', 'Tambah Sertifikasi BNSP');
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-4">
            <h5 class="mb-4">Form Tambah Sertifikasi BNSP</h5>
            <form action="{{ route('certification_bnsp.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row g-3">
                    ...
                    <div class="col-12 col-lg-6">
                        ...
                        <input type="text" name="jenis_sertifikat_bnsp" value="{{ old('jenis_sertifikat_bnsp') }}"
                ...
                <div class="row g-3 mt-2">
                    <div class="col-12 col-lg-6">
                        ...
                        <input type="text" name="nomor_sertifikat_bnsp" value="{{ old('nomor_sertifikat_bnsp') }}"
                    ...
                    <div class="col-12 col-lg-6">
                        ...
                        <input type="text" name="masa_berlaku_sertifikat_bnsp"
                            value="{{ old('masa_berlaku_sertifikat_bnsp') }}" class="form-control"
                ...
                <div class="row g-3 mt-2">
                    <div class="col-12 col-lg-6">
                        ...
                        <input type="date" name="tanggal_terbit_bnsp" value="{{ old('tanggal_terbit_bnsp') }}"
                            class="form-control" placeholder="dd/mm/yyyy">
                    </div>
                    <div class="col-12 col-lg-6">
                        <label class="form-label fs-6">Tanggal Berakhir Sertifikat</label>
                        <input type="date" name="sampai_tanggal_bnsp" value="{{ old('sampai_tanggal_bnsp') }}"
                            class="form-control" placeholder="dd/mm/yyyy">
                    </div>
                </div>
                <div class="row g-3 mt-2">
                    <div class="col-12 col-lg-12">
                        <label class="form-label fs-6">LSP</label>
                        <input type="text" name="lsp_bnsp" value="{{ old('lsp_bnsp') }}" class="form-control"
                            placeholder="Masukan LSP BNSP">
                    </div>
                </div>
                <br>
                <div class="row g-3">
