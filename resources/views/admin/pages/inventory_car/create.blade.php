...
@section('title', 'Tambah Data Inventaris Mobil');
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-4">
            <h5 class="mb-4">Form Tambah Inventaris Mobil</h5>
            <form action="{{ route('inventory_car.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row g-3">
