    ...
    <div class="card">
        <div class="card-body">
            <div class="row row-cols-auto g-3">
                <div class="col">
                    <form action="{{ route('training_eksternal.excell_view_nama') }}" method="POST" class="d-inline">
                        @csrf
                        ...
                        <button type="submit" class="btn btn-success px-5 raised">
                            Download Data Training Eksternal {{ $nama_karyawan }}
                        </button>
                    </form>
                </div>
            </div>
                ...
                <table id="example2" class="table table-striped table-bordered">
                    <thead>
                        ...
                        <tr class="search-row">
                            ...
                            <th><input type="text" class="form-control form-control-sm" placeholder="Cari Jam..." />
                            </th>
                            <th><input type="text" class="form-control form-control-sm"
                                    placeholder="Cari Institusi..." />
                            </th>
                            <th><input type="text" class="form-control form-control-sm" placeholder="Cari Training..." />
                            </th>
                    ...
                    <tbody>
                        ...
                        @foreach ($item_training_eksternals as $item_training_eksternal)
                            <tr>
                                ...
                                <td>{{ $item_training_eksternal->jam_training_eksternal }}</td>
