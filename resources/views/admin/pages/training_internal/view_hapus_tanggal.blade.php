    ...
    <div class="card">
        <div class="card-body">
            <div class="row row-cols-auto g-3">
                <div class="col">
                    <form action="{{ route('training_internal.hapus_tanggal') }}" method="POST" class="d-inline">
                        @csrf
                        <input type="hidden" name="tanggal_training_internal" class="form-control"
                            value="{{ $tanggal_training_internal }}">

                        <button type="submit" class="btn btn-danger px-5 raised">
                            Hapus Data Training Internal Tanggal
                            {{ \Carbon\Carbon::parse($tanggal_training_internal)->isoformat('DD-MM-Y') }}
                        </button>
                    </form>
                </div>
            </div>
