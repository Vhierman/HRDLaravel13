        ...
        <div class="col-md-8 col-lg-6">
            <div class="card">
                ...
                <div class="card-body p-4">
                    <h5 class="mb-4">Cari Data Training Internal Berdasarkan Materi</h5>
                    <form action="{{ route('training_internal.tampil_view_materi') }}" method="post"
                            ...
                            <div class="col-12">
                                ...
                                <select name="materi_training_internal" class="form-select" id="karyawan-select"
                                    ...
                                    @foreach ($item_training_internals as $item_training_internal)
                                        <option value="{{ $item_training_internal->materi_training_internal }}"
                                            {{ old('materi_training_internal') == $item_training_internal->materi_training_internal ? 'selected' : '' }}>
                                            {{ $item_training_internal->materi_training_internal }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
