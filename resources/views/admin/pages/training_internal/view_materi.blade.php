    ...
    <div class="card">
        <div class="card-body">
            <div class="row row-cols-auto g-3">
                <div class="col">
                    <form action="{{ route('training_internal.excell_view_materi') }}" method="POST" class="d-inline">
                        @csrf
                        <input type="hidden" name="materi_training_internal" class="form-control"
                            value="{{ $materi_training_internal }}">

                        <button type="submit" class="btn btn-success px-5 raised">
                            Download Rekap Training {{ $materi_training_internal }}
                        </button>
                    </form>
                </div>
            </div>
