                ...
                <table id="example2" class="table table-striped table-bordered">
                    <thead>
                        ...
                        <tr class="search-row">
                            ...
                            <th><input type="text" class="form-control form-control-sm"
                                    placeholder="Cari Input Oleh..." />
                            </th>
                            <th><input type="text" class="form-control form-control-sm"
                                    placeholder="Cari Tanggal Input..." />
                            </th>
                    ...
                    <tbody>
                        ...
                        @foreach ($item_overtimes as $item_overtime)
                            <tr>
                                ...
                                <td>{{ $item_overtime->input_oleh }}</td>
                                <td>{{ \Carbon\Carbon::parse($item_overtime->created_at)->isoformat('DD-MM-Y') }}</td>
