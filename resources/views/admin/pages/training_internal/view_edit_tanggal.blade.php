                ...
                <div class="row g-3 mt-2">
                    <div class="col-12 col-lg-6">
                        ...
                        <input type="time" name="jam_training_internal"
                            value="{{ old('tanggal_training_internal', $item_training_internals->first()->jam_training_internal) }}"
                    ...
                    <div class="col-12 col-lg-6">
                        ...
                        <input type="text" name="lokasi_training_internal"
                            value="{{ old('tanggal_training_internal', $item_training_internals->first()->lokasi_training_internal) }}"
                ...
                <div class="row g-3 mt-2">
                    <div class="col-12 col-lg-6">
                        ...
                        <input type="text" name="materi_training_internal"
                            value="{{ old('tanggal_training_internal', $item_training_internals->first()->materi_training_internal) }}"
                            class="form-control" placeholder="Masukan Materi Training">
                    </div>
                    <div class="col-12 col-lg-6">
                        <label class="form-label">Trainer</label>
                        <input type="text" name="trainer_training_internal"
                            value="{{ old('tanggal_training_internal', $item_training_internals->first()->trainer_training_internal) }}"
