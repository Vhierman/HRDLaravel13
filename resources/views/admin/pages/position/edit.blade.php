...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-4">
            <h5 class="mb-4">Form Edit Jabatan</h5>
            <form action="{{ route('position.update', $position->id) }}" method="post" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="row mb-3">
                    <label for="input35" class="col-sm-3 col-form-label fs-6">Nama Jabatan</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" onkeyup="huruf(this);" name="jabatan"
                            value="{{ $position->jabatan }}" id="input35" placeholder="Nama Jabatan" />
                    </div>
                </div>
                    ...
                    <div class="col-sm-9">
                        <div class="d-md-flex d-grid align-items-center gap-3">
                            <div class="row row-cols-auto g-3">
                                ...
                                <div class="col">
                                    <a href="{{ route('position.index') }}" class="btn btn-danger px-4 raised d-flex gap-2">
