...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-4">
            <h5 class="mb-4">Proses Kontrak Kerja Karyawan PKWT Berdasarkan Nama</h5>
            <form action="{{ route('kontrak_kerja.proses_nama_pkwt') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row g-3">
